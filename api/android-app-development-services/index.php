...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>A Trusted Android App Development Agency to Perfect Your App</title>
    <meta name="description"
        content="Android app development company that provides quality mobile solutions to help you reach marketing goals. Let us help you create the best mobile app." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="A Trusted Android App Development Agency to Perfect Your App" />
    <meta property="og:description"
        content="Android app development company that provides quality mobile solutions to help you reach marketing goals. Let us help you create the best mobile app." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="A Trusted Android App Development Agency to Perfect Your App" />
    <!-- Canonical -->
...
<body class="main--page android--app services--page">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/android-app-development/hero-fold.php'); ?>
        <?php include('../components/lp/lp-counter.php'); ?>
        <?php include('../components/android-app-development/what-we.php'); ?>
        <?php include('../components/tablet-tabs.php'); ?>
        <?php include('../components/android-app-development/benefits-fold.php'); ?>
        <?php include('../components/why-choose.php'); ?>
        <?php include('../components/our-process.php'); ?>
        <?php include('../components/steps-fold.php'); ?>
        <?php include('../components/android-app-development/integration-fold.php'); ?>
