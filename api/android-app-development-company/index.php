...
<head>
    ...
    <meta name="description"
        content="Through innovative techniques, our Android mobile app developers help bring your ideas to life by creating robust applications that are tailor-made." />
    <!-- OG Tags -->
...
<body class="main--page application-design servicesNewPage androidAppPage">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/android-app-developers-new/hero-fold.php'); ?>
        ...
        <?php 
            // include('../components/android-app-developers-new/ios-laptop-fold.php');
            // include('../components/new-styled-counter-fold.php');
        ?>
        <?php
            include('../components/android-app-developers-new/services-fold.php');
            include('../components/android-app-developers-new/game-fold.php');
        ...
        <?php 
            ...
            include('../components/android-app-development/accordian-fold.php');
