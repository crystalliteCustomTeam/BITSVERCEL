...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>The Best Wearable App Development: Get Custom-Built Solutions</title>
    <meta name="description"
        content="Wearable app development solutions tailored to your specific needs. We create robust and secure apps optimized for the user experience. Call us now." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="The Best Wearable App Development: Get Custom-Built Solutions" />
    <meta property="og:description"
        content="Wearable app development solutions tailored to your specific needs. We create robust and secure apps optimized for the user experience. Call us now." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="The Best Wearable App Development: Get Custom-Built Solutions" />
    <!-- Canonical -->
...
<body class="main--page wearable--app services--page">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/wearable-app-development/hero-fold.php'); ?>
        <?php include('../components/lp/lp-counter.php'); ?>
        <?php include('../components/wearable-app-development/what-we.php'); ?>
        ...
        <?php include('../components/wearable-app-development/integration-fold.php'); ?>
