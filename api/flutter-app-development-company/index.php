...
<body class="main--page application-design servicesNewPage">
    ...
    <main>
        <?php include('../components/flutter-app-developers-new/hero-fold.php'); ?>
        ...
        <?php 
            // include('../components/flutter-app-developers-new/ios-laptop-fold.php');
            // include('../components/new-styled-counter-fold.php');
        ?>
        <?php
            include('../components/flutter-app-developers-new/services-fold.php');
            include('../components/flutter-app-developers-new/game-fold.php');
        ...
        <?php 
            ...
            include('../components/flutter-app-development/accordian-fold.php');
