...
<head>
    ...
    <meta property="og:title" content="Web 3 Development" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Web 3 Development" />
    <!-- Canonical -->
...
<body class="battle-royal">
    ...
    <main>
        <?php
        include('../components/web3-development/hero-fold.php');
        include('../components/web3-development/challenge-fold.php');
        include('../components/web3-development/cta-fold.php');
