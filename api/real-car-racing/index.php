...
<head>
    ...
    <meta property="og:title" content="Real Car Racing" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Real Car Racing" />
    <!-- Canonical -->
...
<body class="real-car-racing">
     <?php include('../components/new-header.php'); ?>
     <main>
          <?php
          include('../components/real-car-racing/hero-fold.php');
          include('../components/real-car-racing/project-prerequisite.php');
          include('../components/real-car-racing/cta-fold.php');
          include('../components/real-car-racing/obstacle-fold.php');
          include('../components/real-car-racing/challenge-fold.php');
          include('../components/real-car-racing/featues-fold.php');
