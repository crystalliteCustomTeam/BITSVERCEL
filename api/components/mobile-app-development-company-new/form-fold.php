<section>
    <div class="form--fold newBlack">
    <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        <div class="card">
                        <h2 class="heading f-45 f-playfair f-700 mb-3 mb-xxl-5 f-center">
                            ...
                            <form id="bottomform">
                                ...
                                <div class="form--btn">
                                    <button type="submit" id="butsave" class="b-gradient">Submit Details</button>
                                </div>
                            </form>
                            <h4 id="success"></h4>
                        </div>
