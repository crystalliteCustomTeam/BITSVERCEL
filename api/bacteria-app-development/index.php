...
<head>
    ...
    <link rel="stylesheet" href="<?= $url; ?>/src/css/germ-guard.min.css" />
...
<body class="main--page iphone--app services--app caseStudyPage">
    ...
    <main>
        <?php include('../components/germ-guard/banner.php'); ?>
        <?php include('../components/germ-guard/overview.php'); ?>
        <?php include('../components/germ-guard/concept.php'); ?>
        <?php include('../components/germ-guard/typeface.php'); ?>
        <?php include('../components/germ-guard/process.php'); ?>
        <?php include('../components/germ-guard/mobiles.php'); ?>
