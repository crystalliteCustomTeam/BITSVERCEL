...
<body class="main--page application-design servicesNewPage">
    ...
    <main>
        <?php include('../components/cross-platform-app-developers-new/hero-fold.php'); ?>
        ...
        <?php 
            // include('../components/cross-platform-app-developers-new/ios-laptop-fold.php');
            // include('../components/new-styled-counter-fold.php');
        ?>
        <?php
            include('../components/hybrid-native.php');
            include('../components/cross-platform-app-developers-new/services-fold.php');
            include('../components/cross-platform-app-developers-new/game-fold.php');
        ...
        <?php 
            ...
            include('../components/crossplatform-app-development/accordian-fold.php');
