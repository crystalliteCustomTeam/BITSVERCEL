...
<head>
    ...
    <meta property="og:title" content="Online Shopping Platform" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Online Shopping Platform" />
    <!-- Canonical -->
...
<body class="nft-marketplace online-shopping-platform">
     <?php include('../components/new-header.php'); ?>
     <main>
          <?php
          include('../components/online-shopping-platform/hero-fold.php');
          include('../components/online-shopping-platform/project-prerequisite.php');
          include('../components/online-shopping-platform/cta-fold.php');
          include('../components/online-shopping-platform/obstacle-fold.php');
          include('../components/online-shopping-platform/challenge-fold.php');
          include('../components/online-shopping-platform/featues-fold.php');
