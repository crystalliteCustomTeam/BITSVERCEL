...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>Unlock the Power of React App Development Services with Us</title>
    <meta name="description"
        content="React App Development Agency that combines cutting-edge technology with creative ideas to craft powerful apps.Call to get a custom-built solution now." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Unlock the Power of React App Development Services with Us" />
    <meta property="og:description"
        content="React App Development Agency that combines cutting-edge technology with creative ideas to craft powerful apps.Call to get a custom-built solution now." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Unlock the Power of React App Development Services with Us" />
    <!-- Canonical -->
...
<body class="main--page react--app services--page">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/react-app-development/hero-fold.php'); ?>
        <?php include('../components/partners-fold.php'); ?>
        <?php include('../components/react-app-development/what-we.php'); ?>
        <?php include('../components/tablet-tabs.php'); ?>
        <?php include('../components/react-app-development/benefits-fold.php'); ?>
        <?php include('../components/why-choose.php'); ?>
        <?php include('../components/our-process.php'); ?>
        <?php include('../components/steps-fold.php'); ?>
        <?php include('../components/react-app-development/integration-fold.php'); ?>
