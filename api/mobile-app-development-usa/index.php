...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>Pioneering Mobile App Development Company In USA - Bitswits</title>
    <meta name="description"
        content="Don't let platform limitations hold you back. Our mobile apps development US company uses the technologies and frameworks to create apps that work seamlessly." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Pioneering Mobile App Development Company In USA - Bitswits" />
    <meta property="og:description"
        content="Don't let platform limitations hold you back. Our mobile apps development US company uses the technologies and frameworks to create apps that work seamlessly." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Pioneering Mobile App Development Company In USA - Bitswits" />
    <!-- Canonical -->
...
<body class="main--page landing--page lp_new light--hero sss mobile--app--usa lpNewStyled">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php
            include('../components/mobile-app-development-usa-page/hero-fold.php');
            include('../components/counter-fold.php');
            include('../components/mobile-app-development-usa-page/technologies-services-fold.php');
