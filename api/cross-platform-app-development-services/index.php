...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>Crossplatform App Development Agency To Make Professional App</title>
    <meta name="description"
        content="Crossplatform Development Company that specializes in building high-quality apps that work seamlessly on all platforms. Connect with us to create apps." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Crossplatform App Development Agency To Make Professional App" />
    <meta property="og:description"
        content="Crossplatform Development Company that specializes in building high-quality apps that work seamlessly on all platforms. Connect with us to create apps." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Crossplatform App Development Agency To Make Professional App" />
    <!-- Canonical -->
...
<body class="main--page crossplatform--app services--app">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/crossplatform-app-development/hero-fold.php'); ?>
        <?php include('../components/lp/lp-counter.php'); ?>
        <?php include('../components/crossplatform-app-development/what-we.php'); ?>
        <?php include('../components/tablet-tabs.php'); ?>
        <?php include('../components/crossplatform-app-development/benefits-fold.php'); ?>
        <?php include('../components/why-choose.php'); ?>
        <?php include('../components/our-process.php'); ?>
        <?php include('../components/steps-fold.php'); ?>
        <?php include('../components/crossplatform-app-development/integration-fold.php'); ?>
