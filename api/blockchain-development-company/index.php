...
<head>
    ...
    <link rel="stylesheet" href="<?= $url; ?>/src/css/blockchain-development-company/page.css" />
...
<body class="flutter--app services--app game-dev gameDevNew nftGamePage blockchainGame">
    ...
    <main>
        <?php include('../components/blockchain-development-company/hero-fold.php');?>
        ...
        <?php
            ...
            include('../components/blockchain-development-company/app-features-fold.php');
            include('../components/blockchain-development-company/blockchain-game-features.php');
            include('../components/blockchain-development-company/technology-fold.php');
            include('../components/blockchain-development-company/casestudy.php');
