...
<head>
    ...
    <meta name="description"
        content="From 2D to 3D, our game developers at Bitswits have the expertise to create stunning visuals that will leave a lasting impression on players." />
    <!-- OG Tags -->
...
<body class="flutter--app services--app game-dev gameDevNew" data-mr="game-development-page">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/game-development/hero-fold.php'); ?>
        ...
        <?php 
            ...
            include('../components/game-development/app-features-fold.php');
            include('../components/game-development/audience-gameplay.php');
            include('../components/game-development/what-we-fold.php');
            include('../components/game-development/expertise-fold.php');
            include('../components/game-development/game-three-cards-fold.php');
            include('../components/game-development/developers-fold.php');
            include('../components/game-development/gaming-projects-fold.php');
    ...
    <!-- Features Slider -->
    <script defer src="<?= $url; ?>/src/sliders/services/game-features.min.js"></script>
    <!-- Three Cards Slider -->
