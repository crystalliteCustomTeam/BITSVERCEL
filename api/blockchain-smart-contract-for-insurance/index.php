...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>Blockchain Smart Contract For Insurance</title>
    ...
    <meta property="og:title" content="Blockchain Smart Contract For Insurance" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Blockchain Smart Contract For Insurance" />
    <!-- Canonical -->
...
<body class="blockchain-smart-contract-for-insurance">
     <?php include('../components/new-header.php'); ?>
     <main>
          <?php
          include('../components/blockchain-smart-contract-for-insurance/hero-fold.php');
          include('../components/blockchain-smart-contract-for-insurance/project-prerequisite.php');
          include('../components/blockchain-smart-contract-for-insurance/cta-fold.php');
          include('../components/blockchain-smart-contract-for-insurance/obstacle-fold.php');
          include('../components/blockchain-smart-contract-for-insurance/challenge-fold.php');
          include('../components/blockchain-smart-contract-for-insurance/featues-fold.php');
