...
<body class="flutter--app services--app game-dev threeD">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/3d-game-development/hero-fold.php'); ?>
        ...
        <?php 
            ...
            include('../components/3d-game-development/app-features-fold.php');
            include('../components/3d-game-development/what-we-fold.php');
            include('../components/3d-game-development/technology-fold.php');
            include('../components/3d-game-development/game-three-cards-fold.php');
            include('../components/3d-game-development/game-demands-fold.php');
            include('../components/3d-game-development/integration-fold.php');
            include('../components/3d-game-development/developers-fold.php');
            include('../components/3d-game-development/gaming-projects-fold.php');
