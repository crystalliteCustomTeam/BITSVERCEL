...
<head>
    ...
    <meta name="description"
        content="Get the most out of your iOS app by working with our top-notch iOS app developers! We have the best team of developers who specialize in feature-rich iOS apps." />
    <!-- OG Tags -->
...
<body class="main--page application-design servicesNewPage">
    ...
    <main>
        <?php include('../components/ios-app-developers/hero-fold.php'); ?>
        ...
        <?php
        // include('../components/ios-app-developers/mobile-game-app.php');
        // include('../components/ios-app-developers/ios-laptop-fold.php');
        // include('../components/new-styled-counter-fold.php');
        ?>
        <?php include('../components/ios-app-developers/technologies-services-fold.php'); ?>
        <?php
        include('../components/ios-app-developers/game-fold.php');
        ...
        include('../components/iphone-app-development/accordian-fold.php');
