...
<body class="flutter--app services--app game-dev twoD">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php include('../components/2d-game-development/hero-fold.php'); ?>
        ...
        <?php 
            ...
            include('../components/2d-game-development/app-features-fold.php');
            include('../components/2d-game-development/what-we-fold.php');
            include('../components/2d-game-development/technology-fold.php');
            include('../components/2d-game-development/game-three-cards-fold.php');
            include('../components/2d-game-development/game-demands-fold.php');
            include('../components/2d-game-development/integration-fold.php');
            include('../components/2d-game-development/developers-fold.php');
            include('../components/2d-game-development/gaming-projects-fold.php');
