...
<head>
    ...
    <meta property="og:title" content="EZ Ride | Bitswits" />
    <meta property="og:description"
        content="iPhone App Development Services to provide you with the best technology solutions to create a powerful app meeting all your needs. Get in touch now." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="EZ Ride | Bitswits" />
    <!-- Canonical -->
    ...
    <link rel="stylesheet" href="<?= $url; ?>/src/css/ez-ride.min.css" />
...
<body class="main--page iphone--app services--app caseStudyPage">
    ...
    <main>
        <?php 
            include('../components/ez-ride/banner.php');
            include('../components/ez-ride/overview.php');
            include('../components/ez-ride/concept.php');
            include('../components/ez-ride/typeface.php');
            include('../components/ez-ride/process.php');
            include('../components/ez-ride/mobiles.php');
