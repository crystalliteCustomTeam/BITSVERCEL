...
<head>
    ...
    <meta property="og:title" content="NFT Market Place" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="NFT Market Place" />
    <!-- Canonical -->
...
<body class="nft-marketplace">
     <?php include('../components/new-header.php'); ?>
     <main>
          <?php
          include('../components/nft-marketplace/hero-fold.php');
          include('../components/nft-marketplace/project-prerequisite.php');
          include('../components/nft-marketplace/cta-fold.php');
          include('../components/nft-marketplace/obstacle-fold.php');
          include('../components/nft-marketplace/challenge-fold.php');
          include('../components/nft-marketplace/featues-fold.php');
