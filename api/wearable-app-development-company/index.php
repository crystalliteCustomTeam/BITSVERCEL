...
<head>
    ...
    <meta name="description"
        content="Discover Premier wearable app developers at BitsWits, specializing in innovative solutions and technology for all devices. Elevate your business today!" />
    <!-- OG Tags -->
    ...
    <link rel="stylesheet" href="<?= $url; ?>/src/css/custom-slider.min.css" />
...
<body class="main--page application-design servicesNewPage">
    ...
    <main>
        <?php include('../components/wearable-app-developers-new/hero-fold.php'); ?>
        ...
        <?php 
            // include('../components/wearable-app-developers-new/ios-laptop-fold.php');
            // include('../components/new-styled-counter-fold.php');
        ?>
        <?php
            include('../components/wearable-app-developers-new/services-fold.php');
            include('../components/wearable-app-developers-new/game-fold.php');
        ...
        <?php 
            ...
            include('../components/wearable-app-development/accordian-fold.php');
    ...
    <!-- Banner Slider -->
    <script defer src="<?= $url; ?>/src/sliders/services/banner-3d.min.js"></script>
    <!-- Laptop Slider  -->
