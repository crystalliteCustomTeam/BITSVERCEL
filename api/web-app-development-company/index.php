...
<body class="main--page application-design servicesNewPage">
    ...
    <main>
        <?php include('../components/web-app-developers-new/hero-fold.php'); ?>
        ...
        <?php 
            // include('../components/web-app-developers-new/ios-laptop-fold.php');
            // include('../components/new-styled-counter-fold.php');
        ?>
        <div class="d-md-block d-none">
            <?php include('../components/web-app-developers-new/programming-languages-fold.php'); ?>
        </div>
        <?php 
            include('../components/web-app-developers-new/game-fold.php');
    ...
    <script defer src="<?= $url; ?>/src/sliders/programming-languages.min.js"></script>
    <!-- Read More -->
