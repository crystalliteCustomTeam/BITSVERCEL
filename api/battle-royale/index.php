...
<head>
    ...
    <meta property="og:title" content="Battle Royale" />
    <meta property="og:description"
        content="Your chance to get insights into how we made a music streaming app! This details the music streaming app development process from start to finish." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="Battle Royale" />
    <!-- Canonical -->
...
<body class="battle-royal">
    <?php include('../components/new-header.php'); ?>
    <main>
        <?php
        include('../components/battle-royal/hero-fold.php');
        include('../components/battle-royal/challenge-fold.php');
        include('../components/battle-royal/cta-fold.php');
        include('../components/battle-royal/battleVideo.php');
