...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Title & Description -->
    <title>New Ways to Explore with Travel App Development: A Case Study</title>
    <meta name="description"
        content="Travel app development needs careful planning and creative thinking.This case study details how we made a thriving travel app with our clever approach." />
    <!-- OG Tags -->
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="New Ways to Explore with Travel App Development: A Case Study" />
    <meta property="og:description"
        content="Travel app development needs careful planning and creative thinking.This case study details how we made a thriving travel app with our clever approach." />
    <meta property="og:url" content="<?= $url; ?>" />
    <meta property="og:site_name" content="New Ways to Explore with Travel App Development: A Case Study" />
    <!-- Canonical -->
    ...
    <link rel="stylesheet" href="<?= $url; ?>/src/css/bliss-travel.min.css" />
...
<body class="main--page iphone--app services--app caseStudyPage">
    ...
    <main>
        <?php 
            include('../components/bliss-travel/banner.php');
            include('../components/bliss-travel/overview.php');
            include('../components/bliss-travel/concept.php');
            include('../components/bliss-travel/typeface.php');
            include('../components/bliss-travel/process.php');
            include('../components/bliss-travel/mobiles.php');
