...
<body class="main--page mobile-app-new home--page newHomePage ">
    <div class="bg-w b-color">
        <?php include('../components/new-header.php'); ?>
    </div>
    <main>
        <?php
        include('../components/mobile-app-development-company-new/hero-fold.php');
        ?>

        <?php include('../components/home-page/awards-fold.php'); ?>
        <div class="d-md-block d-none">
            <?php include('../components/mobile-app-development-company-new/form-fold.php'); ?>
        </div>
        <div class="d-md-none d-block">
            <?php include('../components/mobile-app-development-company-new/new-form-fold-mobile.php'); ?>
        </div>
        <?php include('../components/mobile-app-development-company-new/about-fold.php'); ?>
        <?php include('../components/home-page/services-fold.php'); ?>
        <?php include('../components/hybrid-native.php'); ?>
